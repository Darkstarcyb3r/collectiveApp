// LightTabBar - Light-themed bottom tab bar for group screens
// Same auto-hide animation as AutoHideTabBar but with light background
      ...
      {TABS.map((tab) => (
        ...
        >
          <View style={styles.iconWrapper}>
            <Ionicons name={tab.icon} size={24} color={colors.offline} />
